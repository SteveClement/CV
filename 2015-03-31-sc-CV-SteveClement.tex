...
\header{Steve}{Clement}{information technology \& science mentor} % Your name \& current job title/field
...
{Luxembourg}
{\emph{1\textsuperscript{st} Operational Core Security Team for Luxemgourg} \\
