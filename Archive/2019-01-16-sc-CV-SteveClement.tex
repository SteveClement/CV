...
\header{Steve}{Clement}{Information Security expert \& Science mentor} % Your name \& current job title/field
...
%%{}
%%{MISP is becoming one of the main players in the threat sharing landscape and after being part since 2002 when CIRCL took over the project. Having been exposed to various community building efforts, the knowledge of best practices has been developed.}
%------------------------------------------------
